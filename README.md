...
- **Produção assistencial**: consolida quantidade de atendimentos, guias e valores por profissional e paciente, respeitando a competência selecionada, e exporta cada sessão em CSV para conferência e repasse.
